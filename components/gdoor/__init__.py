...
CONFIG_SCHEMA = cv.COMPONENT_SCHEMA.extend({
    ...
    cv.Optional(CONF_RX_PIN, default='GPIO22'): cv.gpio_input_pin_schema,
    cv.Optional(CONF_SENSITIVITY, default=1.65): cv.positive_float.validators(cv.Range(min=1.3, max=1.65))
})
